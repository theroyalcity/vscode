...
export class RemoteAgentService extends AbstractRemoteAgentService implements IRemoteAgentService {
	...
	constructor(
		...
		this.fxdkConnection = this._register(new RemoteAgentConnection(window.location.host, productService.commit, this.socketFactory, remoteAuthorityResolverService, signService, logService));
	}
